...
![Assignment 2 screenshot](screenshots/ass02-pwd-codetrack.png)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![Assignment 2 screenshot](screenshots/ass02-git-status-no-git-rep-error.png)
...
![Assignment 2 screenshot](screenshots/ass02-ls-starter-ui-files.png)
...
![Assignment 2 screenshot](screenshots/ass02-contents-index-html.png)
![Assignment 2 screenshot](screenshots/ass02-contents-style-css.png)
...
![Assignment 2 screenshot](screenshots/ass02-git-status-untracked.png)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![Assignment 2 screenshot](screenshots/ass02-git-status-changes-committed.png)
...
![Assignment 2 screenshot](screenshots/ass02-first-commit-starter-file.png)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![Assignment 2 screenshot](screenshots/ass02-git-log-oneline-output.png)
...
![Assignment 2 screenshot](screenshots/ass02-browser-output.png)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![Assignment 2 screenshot](screenshots/ass02-git-status-index-html-modified.png)

---

#### Screenshot 11 — Output of `git commit`

![Assignment 2 screenshot](screenshots/ass02-git-commit-update-output.png)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![Assignment 2 screenshot](screenshots/ass02-git-log-oneline-two-commits.png)
...
![Assignment 2 screenshot](screenshots/ass02-nginx-status-active.png)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![Assignment 2 screenshot](screenshots/ass02-curl-showing-http-200-ok.png)

---

#### Screenshot 15 — Browser showing the CodeTrack site loaded at `http://<EC2_PUBLIC_IP>`, with your Full Name and Group Name visible

![Assignment 2 screenshot](screenshots/ass02-codetrack-site-loaded.png)
...
`https://www.linkedin.com/posts/solomonanichebe_devops-git-aws-activity-7486826996249911296-7Tg_?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAXBpdEBaUln31DVzGUPS7Q7mpZjlUYg8QY`

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![Assignment 2 screenshot](screenshots/ass04-linkedIn-post-codetrack.png)

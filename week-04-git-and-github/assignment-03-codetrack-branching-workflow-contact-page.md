...
![Assignment 3 screenshot](screenshots/ass03-git-status-branch-clean.png)
...
![Assignment 3 screenshot](screenshots/ass03-git-checkout-branch-output.png)
---
...
![Assignment 3 screenshot](screenshots/ass03-ls-contact.png)
...
![Assignment 3 screenshot](screenshots/ass03-git-log-oneline-output.png)
...
![Assignment 3 screenshot](screenshots/ass03-contact-link-added-index.png)

---

#### Screenshot 7 — Output of `git commit`

![Assignment 3 screenshot](screenshots/ass03-git-commit-contact-link-added.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Assignment 3 screenshot](screenshots/ass03-browser-index-contain-contact-link.png)
...
![Assignment 3 screenshot](screenshots/ass03-default-branch-isolation.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Assignment 3 screenshot](screenshots/ass03-default-branch-no-contact-page-link.png)
...
![Assignment 3 screenshot](screenshots/ass03-merge-feature-branch-to-default-branch.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Assignment 3 screenshot](screenshots/ass03-contact-added4-default-branch-merge.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Assignment 3 screenshot](screenshots/ass03-contact-page-4-default-branch.png)
...
![Assignment 3 screenshot](screenshots/ass03-graph-view-git-log.png)
...
![Assignment 3 screenshot](screenshots/ass03-feature-contact-page-deleted.png)

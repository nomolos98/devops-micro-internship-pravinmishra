...
![Assignment 3 screenshot](screenshots/showing-claude-skills-folders.png)
![Assignment 3 screenshot](screenshots/showing-subfolder-claude-skills-folders.png)
...
![Assignment 3 screenshot](screenshots/claude-skills-folders-structure.png)
...
![Assignment 3 screenshot](screenshots/tf-plan-SKILL.png)
...
![Assignment 3 screenshot](screenshots/Scalfold-terraform.png)
![Assignment 3 screenshot](screenshots/Scalfold-terraform1.png)

---

#### Screenshot 5 — VS Code sidebar showing the `terraform/` folder with all generated files inside

![Assignment 3 screenshot](screenshots/terraform-vscode-visible.png)
...
![Assignment 3 screenshot](screenshots/tf-plan-output.png)

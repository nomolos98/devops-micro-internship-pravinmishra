...
![Assignment 2 screenshot](screenshots/claude-response-b4-clade-md.png)
...
![Assignment 2 screenshot](screenshots/auto-generated-claude-claude.mg.png)
...
![Assignment 2 screenshot](screenshots/customized-claude-md.png)
---
...
![Assignment 2 screenshot](screenshots/claude-response-after.png)

---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

![Assignment 2 screenshot](screenshots/claude-response-after-flagchanges.png)
...
![Assignment 2 screenshot](screenshots/claude-md-commit.png)

#### Screenshot 6 — `CLAUDE.md` visible in your GitHub repository after pushing the commit

![Assignment 2 screenshot](screenshots/claude-md-visible.png)
![Assignment 2 screenshot](screenshots/claude-md-visible1.png)

...
![Assignment 2 screenshot](screenshots/ass02-resource-group-overview.png)
...
![Assignment 2 screenshot](screenshots/ass02-azure-vm-overviewpage.png)

---

#### Screenshot 3 — Network Security Group inbound rules showing ports 22 and 80 allowed

![Assignment 2 screenshot](screenshots/ass02-azure-vm-inbound-section.png)
...
![Assignment 2 screenshot](screenshots/ass02-terminal-showing-successful-ssh-login.png)
...
![Assignment 2 screenshot](screenshots/ass02-terminal-showing-node-v-npm-v.png)
...
![Assignment 2 screenshot](screenshots/ass02-npm-run-build.png)

![Assignment 2 screenshot](screenshots/ass02-ls-la-build.png)
...
![Assignment 2 screenshot](screenshots/ass02-successful-sudo-nginx-t.png)

---

#### Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive

![Assignment 2 screenshot](screenshots/ass02-nginx-config-builtroot-tryfiles.png)
...
![Assignment 2 screenshot](screenshots/ass02-browser-react-app-public-ip.png)
...
![Assignment 2 screenshot](screenshots/ass02-network-security-group-myip.png)

...
![Assignment 2 screenshot](screenshots/node-npm-version.png)
...
![Assignment 2 screenshot](screenshots/output-systemctl-status-nginx-no-pager.png)
...
![Assignment 2 screenshot](screenshots/my-react-app-list.png)
...
![Assignment 2 screenshot](screenshots/nano-app-js.png)
...
![Assignment 2 screenshot](screenshots/my-react-app-build.png)
...
![Assignment 2 screenshot](screenshots/build-4-var-www-html.png)
...
![Assignment 2 screenshot](screenshots/systemctl-is-active.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Assignment 2 screenshot](screenshots/cat-etc-nginx-sites-available.png)
...
![Assignment 2 screenshot](screenshots/curl-config-me.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Assignment 2 screenshot](screenshots/deployed-react-app.png)
...
`https://www.linkedin.com/posts/solomonanichebe_devops-git-aws-activity-7487220508925714432-3EFt?utm_source=share&utm_medium=member_desktop&rcm=ACoAAAXBpdEBaUln31DVzGUPS7Q7mpZjlUYg8QY`

---

#### Screenshot — LinkedIn post showing the deployed application

![Assignment 2 screenshot](screenshots/ass02-linkedIn-deployed-application.png)
